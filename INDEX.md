# 📚 IVA TIME Documentation Index · فهرست مستندات
...
│
├── 📄 WIKI-DEPLOY.md               ← Wiki deployment guide
│
...
│   │
│   ├── 📍 Features
│   │   ├── World-Clocks.md         ← City list & features
│   │   ├── Calendar-System.md       ← Jalali/Gregorian calendar
│   │   ├── NTP-Synchronization.md  ← Time sync explained
│   │   └── Bilingual-Support.md     ← RTL/LTR system
│   │
│   ├── 📍 Development
│   │   ├── Architecture.md         ← Technical architecture
│   │   ├── Adding-New-Cities.md    ← Step-by-step guide
...
- 🐛 **Bug Reports**: https://github.com/Kourosh242/iva-time/issues
- 💡 **Feature Requests**: https://github.com/Kourosh242/iva-time/issues
- 📦 **Releases**: https://github.com/Kourosh242/iva-time/releases
- 📖 **Wiki**: https://github.com/Kourosh242/iva-time/wiki
